...
export class Lexer {
  ...
  private readonly KEYWORDS = new Set([
    ...
    "DESC", "ASC", "LIMIT", "OFFSET", "INNER", "LEFT", "RIGHT", "FULL", "OUTER", "JOIN", "ON", "GROUP", "HAVING", "AS", "RETURNING", "BETWEEN",
    ...
    "WITH", "UNION", "INTERSECT", "DO", "LANGUAGE", "$DO", "SCHEMA", "IF", "EXISTS", "CASCADE", "RESTRICT", "DROP", "FILTER", "INTERVAL", "ESCAPE", "ILIKE", "DISTINCT",
